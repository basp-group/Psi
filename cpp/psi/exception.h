#ifndef PSI_EXCEPTION
#define PSI_EXCEPTION
...
public:
  ...
  Exception(std::string const &filename, size_t lineno)
      : Exception("psi::Exception", filename, lineno) {}
...
#define PSI_THROW(MSG) throw(psi::Exception(__FILE__, __LINE__) << "\n" << MSG)
