#ifndef PSI_PROJECTED_ALGORITHM_H
#define PSI_PROJECTED_ALGORITHM_H
...
public:
  ...
  //! Performs algorithm and project results onto positive quadrant
  template <class... T> DiagnosticAndResult operator()(T &... args) {
    auto result = algorithm()(std::forward<T &>(args)...);
