#ifndef PSI_BISECTION_METHOD_H
#define PSI_BISECTION_METHOD_H
...
bisection_method(const K &function_value, const std::function<K(K)> &func, const K &a, const K &b,
  ...
  t_real eta = (a + b) * 0.5;
   PSI_LOW_LOG("Starting bisection method over x ∈ [{}, {}], to estimate f(x) = {}", a, b,
                function_value);
 ...
 //   PSI_LOW_LOG("|f(x_0) - f(x)| = {}, x = {}, [{}, {}]", relative_difference, eta, lower_eta,
 //                upper_eta);
  }
  return eta;
}
