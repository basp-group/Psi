...
TEST_CASE("Power Method Blocking") {
...
TEST_CASE("Power Method Blocking 2") {
  using namespace psi;
  typedef t_real Scalar;
  ...
  SECTION("Power Method") {
    auto op_norm = algorithm::power_method_blocking<Vector<t_complex>,Matrix<t_complex>>(op, power_iters, power_tol, input);
    CAPTURE(eigenvalue);
